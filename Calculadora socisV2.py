...
if "mostrar_inversores" in st.session_state and st.session_state["mostrar_inversores"]:
    ...
    with pd.ExcelWriter(excel_buffer, engine='xlsxwriter') as writer:
        ...
        pre_df = pd.DataFrame({"Concepto": ["Costes", "Gastos", "Ingresos", "Beneficio", "Valor Potencial", "Valor Final"],
                               "Valor": [valor_coste, inversion_gastos, ingresos_anuales, beneficio_estimado, valor_potencial, valor_final]})
